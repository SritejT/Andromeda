...
risk_area = pygame.image.load('game_images/risk_area.png')
risk_area = pygame.transform.scale(risk_area, (72, 72))
risk_meter = pygame.image.load('game_images/risk_meter.png')
...
def run():
    ...
    if 270 < virus_x < 810 and 180 < virus_y < 540:
    ...
    while virus_killing:
        ...
        if not (270 < virus_x < 810 and 180 < virus_y < 540):
    ...
    while game_running:
        ...
        enlarged_risk_area = pygame.transform.scale(risk_area, (risk_area_size, risk_area_size))

        screen.blit(enlarged_risk_area, (virus_x - 36, virus_y - 36))
        ...
        if not_at_risk and (character_x + 72 > virus_x - 36 and virus_x - 36 + risk_area_size > character_x and character_y + 72 > virus_y - 36 and virus_y - 36 + risk_area_size > character_y):

            risk += 1

            not_at_risk = False

        if not (character_x + 72 > virus_x - 36 and virus_x - 36 + risk_area_size > character_x and character_y + 72 > virus_y - 36 and virus_y - 36 + risk_area_size > character_y):
        ...
        if risk >= 1:
            ...
            screen.blit(risk_meter, (50, 50))

        if risk >= 2:

            screen.blit(risk_meter, (74, 50))
    ...
    while game_over:
        ...
        if high_score:
            ...
            high_score_text = font.render('A new high score!', True, grey)
            high_score_text_rect = text.get_rect()
            high_score_text_rect.center = (530, 488)
